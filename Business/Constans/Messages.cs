...
namespace Business.Constans
{
    public class Messages
    {
        ...
        public static string CompanyAlreadyExists = "Bu Şirket Önceden Kaydedilmiş";
        ...
        public static string AddedAccountReconciliation = "Cari mutabakat kaydı başarılı";
        public static string DeletedAccountReconciliation = "Cari mutabakat silme başarılı";
        public static string UpdatedAccountReconciliation = "Cari mutabakat güncelleme başarılı";

        public static string AddedAccountReconciliationDetail = "Cari mutabakat detay kaydı başarılıyla eklendi";
        public static string DeletedAccountReconciliationDetail = "Cari mutabakat detay kaydı silme başarılı";
        public static string UpdatedAccountReconciliationDetail = "Cari mutabakat detay güncelleme başarılı";
